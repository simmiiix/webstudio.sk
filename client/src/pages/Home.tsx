...
const PRICING = [
  {
    ...
    price: "490",
    period: "jednorazovo",
    desc: "Ideálne pre freelancerov, remeselníkov a malé prevádzky.",
    features: [
      "Až 5 podstránok",
      "Responzívny dizajn",
      "Kontaktný formulár",
  ...
  },
  {
    ...
    price: "990",
    period: "jednorazovo",
    desc: "Pre firmy, ktoré chcú profesionálnu prezentáciu a viac zákazníkov.",
    features: [
      "Až 15 podstránok",
  ...
  },
  {
    ...
    price: "1 490",
    period: "jednorazovo",
    desc: "Kompletný online obchod s platobnou bránou a správou produktov.",
    features: [
      "Neobmedzené produkty",
      "Platobná brána",
      "Správa objednávok",
      "Zľavové kódy",
      "Napojenie na skladový systém",
      "E-mailový marketing",
      "6 mesiacov podpory",
    ],
    cta: "Vybrať E-shop",
